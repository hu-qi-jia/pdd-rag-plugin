...
> 版本 2.4 · 2026-09-15 · 对齐 Figma 编辑器工具界面(与 pddddd 控制台同一设计语言;v2.0 的 Figma 营销官网风整体替换)
...
| `btnPrimaryBg` | `#161616`(白字) | `#E6E6E6`(黑字) | 主按钮(黑白反转;**仅按钮**) |
...
- **内容缩进对齐文件夹名**:标准回答行 `padding-left = 28 + 12×深度`,行悬浮 `bgSecondary`。
