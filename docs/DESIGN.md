...
> 版本 2.6.9 · 2026-09-15 · 对齐 Figma 编辑器工具界面(与 pddddd 控制台同一设计语言;v2.0 的 Figma 营销官网风整体替换)
...
「设置标准回答」主钮位置(v2.6.9 终版):**每条回复行内各自携带**(单/多回复口径统一;
v2.6.6 曾把单回复卡片的按钮移到底部操作行,本轮按用户要求放回回答条目后方);
