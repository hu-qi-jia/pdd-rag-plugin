...
> 版本 2.3 · 2026-09-15 · 对齐 Figma 编辑器工具界面(与 pddddd 控制台同一设计语言;v2.0 的 Figma 营销官网风整体替换)
...
**记忆列表卡片**(同一工具语言):卡片头左侧 24px 折叠钮(chevron,折叠时旋转 -90°,带 `aria-expanded`;
整行仍可点击折叠);展开区左缩进 `controlH.inline + spacing.sm`,与问题文本对齐;
